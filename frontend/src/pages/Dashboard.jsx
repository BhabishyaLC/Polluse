    ...
    <div class="bg-slate-50 text-slate-800 font-sans min-h-screen flex flex-col overflow-x-hidden relative">
      ...
      <nav class="w-full bg-white border-b border-slate-200 px-6 py-4 flex justify-between items-center z-10 shadow-sm">
        <div class="flex items-center space-x-2.5">
          ...
          <span class="text-xl font-black text-slate-900 tracking-tight">Polluse.</span>
        </div>
      ...
      >
        ...
        <motion.section variants={itemVariants} class="grid grid-cols-1 sm:grid-cols-3 gap-4">
          <div class="bg-white border border-slate-200 p-5 rounded-xl flex items-center justify-between shadow-sm backdrop-blur-sm">
            <div>
              <p class="text-[10px] font-bold text-slate-400 uppercase tracking-widest mb-0.5">Total Active Polls</p>
              <h3 class="text-2xl font-bold text-slate-900 tracking-tight">12</h3>
            </div>
          ...
          <div class="bg-white border border-slate-200 p-5 rounded-xl flex items-center justify-between shadow-sm backdrop-blur-sm">
            <div>
              <p class="text-[10px] font-bold text-slate-400 uppercase tracking-widest mb-0.5">Captured Votes</p>
              <h3 class="text-2xl font-bold text-slate-900 tracking-tight">1,420</h3>
            </div>
            <div class="w-9 h-9 rounded-lg bg-slate-50 border border-slate-200 flex items-center justify-center text-slate-500">
              <Users size={16} />
            </div>
          ...
          <div class="bg-white border border-slate-200 p-5 rounded-xl flex items-center justify-between shadow-sm backdrop-blur-sm">
            <div>
              <p class="text-[10px] font-bold text-slate-400 uppercase tracking-widest mb-0.5">Real-time Stream</p>
              <h3 class="text-2xl font-bold text-slate-900 tracking-tight">3 <span class="text-[10px] text-emerald-600 font-bold bg-emerald-50 px-1.5 py-0.5 rounded ml-1 border border-emerald-200 animate-pulse">Live</span></h3>
            </div>
            <div class="w-9 h-9 rounded-lg bg-slate-50 border border-slate-200 flex items-center justify-center text-slate-500">
              <BarChart3 size={16} />
            </div>
        ...
        <motion.section variants={itemVariants} class="bg-white/90 border border-slate-200 p-6 rounded-2xl shadow-sm backdrop-blur-sm">
          <div class="flex items-center gap-2 mb-5">
            <PlusCircle size={18} class="text-slate-800" />
            <h2 class="text-sm font-bold text-slate-900 uppercase tracking-wider">Generate a Live Poll Node</h2>
          </div>

          <form class="space-y-4" onSubmit={(e) => e.preventDefault()}>
            <div>
              <label class="block text-[10px] font-bold text-slate-400 uppercase tracking-widest mb-1.5">Prompt Question</label>
              <input 
                type="text" 
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-3">
              <div>
                <label class="block text-[10px] font-bold text-slate-400 uppercase tracking-widest mb-1.5">Option A</label>
                <input 
                  type="text" 
              ...
              <div>
                <label class="block text-[10px] font-bold text-slate-400 uppercase tracking-widest mb-1.5">Option B</label>
                <input 
                  type="text" 
              ...
              <div>
                <label class="block text-[10px] font-bold text-slate-400 uppercase tracking-widest mb-1.5">Option C (Optional)</label>
                <input 
                  type="text" 
        ...
        <motion.section variants={itemVariants} class="space-y-3">
          <div class="flex items-center justify-between mb-1 px-1">
            <div class="flex items-center gap-2">
              ...
              <h2 class="text-xs font-bold text-slate-400 uppercase tracking-widest">Active System Feeds</h2>
            </div>
          </div>
          ...
          <div class="bg-white/90 border border-slate-200 p-4 rounded-xl shadow-sm hover:border-slate-300 transition-all backdrop-blur-sm">
            <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-3 pb-2.5 border-b border-slate-100">
              <div>
                ...
                <h4 class="text-sm font-semibold text-slate-800">Preferred State Management Tool for 2026?</h4>
              </div>
              <div class="flex items-center space-x-1 self-start sm:self-auto">
                <button class="p-2 bg-slate-50 hover:bg-slate-100 border border-slate-200 text-slate-500 rounded-lg transition-colors cursor-pointer" title="Copy URL">
                  <Copy size={13} />
                </button>
                <button class="p-2 bg-slate-50 hover:bg-slate-100 border border-slate-200 text-slate-500 rounded-lg transition-colors cursor-pointer" title="Open View">
                  <ExternalLink size={13} />
                </button>
                <button class="p-2 bg-slate-50 hover:bg-rose-50 border border-slate-200 hover:border-rose-200 text-slate-400 hover:text-rose-500 rounded-lg transition-colors cursor-pointer" title="Terminate">
                  <Trash2 size={13} />
                </button>
              </div>
            </div>
            ...
            <div class="pt-2.5 flex items-center justify-between text-xs text-slate-500">
              <span>Total Payload: <strong class="text-slate-700 font-medium">432 records</strong></span>
              <span class="text-slate-700 font-semibold bg-slate-100 border border-slate-200 px-2 py-0.5 rounded-md text-[11px]">Zustand Leading (54%)</span>
            </div>
          </div>
          ...
          <div class="bg-white/60 border border-slate-200/80 p-4 rounded-xl shadow-sm opacity-70 backdrop-blur-sm">
            <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-3 pb-2.5 border-b border-slate-100">
              <div>
                ...
                <h4 class="text-sm font-semibold text-slate-600">Is serverless deployment the future of backends?</h4>
              </div>
              <div class="flex items-center space-x-1 self-start sm:self-auto">
                <button class="p-2 bg-slate-50 hover:bg-rose-50 border border-slate-200 hover:border-rose-200 text-slate-400 hover:text-rose-500 rounded-lg transition-colors cursor-pointer" title="Purge">
                  <Trash2 size={13} />
                </button>
              </div>
            </div>
            ...
            <div class="pt-2.5 flex items-center justify-between text-xs text-slate-400">
              ...
              <span class="text-slate-500 font-medium flex items-center gap-1 text-[11px]"><CheckCircle size={12} class="text-slate-400" /> Yes absolute (78%)</span>
            </div>
          </div>
